...
namespace HideFilePDF
{
    internal class EncryptDecrypt
    {
        ...
        //            saltGlobal = salt;
        //            byte[] encryptionKey = createKey(password, salt);
        ...
        //                File.WriteAllBytes(saltFile, (saltGlobal));
        ...
        //            //File.WriteAllText(fileName, ByteArrayToHexString(encryptionKey));
        //            MessageBox.Show("File đã được mã hóa !.");
        //        }
        //        catch (Exception ex)
        //        {
        //            MessageBox.Show($"Lỗi : {ex.Message}");
        ...
        //    else
        //    {
        //        MessageBox.Show("File đã được mã trước đó !!!");
        //    }
